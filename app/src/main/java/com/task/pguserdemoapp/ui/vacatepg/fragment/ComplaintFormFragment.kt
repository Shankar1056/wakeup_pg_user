...
import com.task.pguserdemoapp.databinding.FragmentComplaintFormBinding
...
class ComplaintFormFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var binding: FragmentComplaintFormBinding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_complaint_form, container, false)
